...
def main():
    imgQuery = cv2.imread('evaluation/test-images/Skalierung/St. Peter/0.JPG', 0)
    imgPathList = []   

    imgPathList.append(cv2.imread('evaluation/test-images/Skalierung/St. Peter/10.JPG', 0))    
    imgPathList.append(cv2.imread('evaluation/test-images/Skalierung/St. Peter/20.JPG', 0))    
    imgPathList.append(cv2.imread('evaluation/test-images/Skalierung/St. Peter/30.JPG', 0))    
    imgPathList.append(cv2.imread('evaluation/test-images/Skalierung/St. Peter/40.JPG', 0))        
